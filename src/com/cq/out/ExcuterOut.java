...
public class ExcuterOut extends SimpleExcuter {

	public ExcuterOut(int h, int m, int s) {
		super(h, m, s);
	}

	public static void main(String[] args) {
		new ExcuterOut(22,31,0);
	}
	...
	public void doCheck() {
		...
		try {	
			...
			wdwE.until(ExpectedConditions.presenceOfElementLocated(By.id("checkout_btn")));
			exc.findElementById("checkout_btn").click();
			int aTimes = 0;
			do{
				Thread.sleep(3000);
